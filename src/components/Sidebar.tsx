...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Panel */}
      <aside
        className={`fixed top-0 left-0 bottom-0 w-72 bg-white z-50 shadow-2xl flex flex-col transform transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="px-6 py-5 flex items-center justify-between border-b border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-gray-900 text-sm">375 Dashboard</span>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-4 border-t border-gray-100 space-y-3">
          ...
          <p className="text-[11px] text-gray-300 text-center">375 Technology</p>
        </div>
      </aside>
    </>
  );
