...
export default function TransactionTile({
  ...
  const excludedKeys = [
    ...
    "expensesQris",
    "expensesOnline",
    "isDiscrepancyConfirmed",
    "preConfirmTotal",
    "preConfirmSubTotal",
    "confirmedDeltaCash",
    "confirmedDeltaQris",
    "confirmedDeltaOnline",
    "originalActualCash",
    "originalActualQris",
    "originalActualOnline",
    "originalDiscrepancyCash",
    "originalDiscrepancyQris",
    "originalDiscrepancyOnline",
    "preAnchorClosingCash",
    "preAnchorClosingQris",
    "preAnchorClosingOnline",
    "anchorCash",
    "anchorQris",
    "anchorOnline",
  ];
